...
**MTZP ESP32 Hub** — это шлюз на базе ESP32 для устройства защиты МТЗП-2. Проект предоставляет WiFi-доступ к устройству через RS485 с использованием протокола SLIP, веб-интерфейс для мониторинга и настройки, а также REST API для чтения/записи регистров.
